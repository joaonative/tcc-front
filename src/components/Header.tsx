...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="w-full fixed bottom-0 bg-white dark:bg-dark lg:dark:bg-darkBg lg:relative lg:flex items-center justify-between py-5 lg:px-12 md:px-8 px-4">
